...
### HumanEval公式50問（純粋実力測定）

| 測定 | 問題数 | pass@1 | 備考 |
|------|--------|--------|------|
| 独自問題（T44〜T51） | 8問 | 87.5% | 小サンプル・参考値 |
| 公式HumanEval | 50問 | 66.0% | より信頼できる実力値 |

- モデル：qwen2.5:3b（良い例・悪い例なし・純粋実力測定）
- 詳細：benchmarks/humaneval_official.py

> 補足：一般的な3BモデルのHumanEval pass@1は20〜40%台が標準。
> sdnd-devのマルチエージェント構成による改善効果を示しています。
